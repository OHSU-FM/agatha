  ...
  module ResponseSets
    ...
    class ResponseSetBase
      ...
      def related_columns
        ...
        @related_columns = find_related_columns [question.rc_resp_name]
      end
      ...
      def related_error_columns
        ...
        if status_questions
          @related_error_columns = find_related_columns status_questions.map{|sq|sq.rc_resp_name}
        end
      ...
      def find_related_columns col_names
        ...
        col_names.each do |col_name|
          result += question.survey.column_names.select{|col|col.start_with? col_name}
        end
        return result
      end
      ...
      def find_related_data col_names
        ...
        question.survey.lime_data.dataset.each do |row|
          col_names.each do |col|
            result[col].push row.values.first[col]
          end
        end
        return result
      end
    ...
    class ResponseSetGeneric < ResponseSetBase
      ...
      def data_labels
        ...
        @data_labels = {}
        lime_answers.each{|ans|
          @data_labels[ans.code] = ans.answer if scale_id == ans.scale_id
        }
        return @data_labels
      end
    end
    ...
    class ResponseSetNumeric < ResponseSetGeneric
      ...
      def initialize question, opts={}
        super(question, opts)
        @format_as = question.num_value_int_only? ? :integer : :float
      end
    ...
    class ResponseSetMult < ResponseSetGenericParent
      ...
      def data
        ...
        question.sub_questions.each do |sq|
          responses = related_data[sq.rc_resp_name] || []
      ...
      def data_labels
        ...
        question.sub_questions.each do |squestion|
          raise hell if squestion.title.include? 'other'
          next if squestion.rc_resp_name.end_with? 'other'
    ...
    class ResponseSetMultComment < ResponseSetMult
      ...
      def data_labels
        ...
        @data_labels = {}
        question.sub_questions.each do |squestion|
          raise hell # rc_resp_name can end in a bracket?
    ...
    class ResponseSetMultNumeric < ResponseSetGenericParent
      ...
      def data
        ...
        question.sub_questions.each do |sub_question|
          @format_as = sub_question.num_value_int_only? ? :integer : :float
    ...
    class ResponseSetDualArr < ResponseSetGeneric
      ...
      def data
        ...
        question.sub_questions.each do |sub_question|
          ...
          @data.push ResponseSetGeneric.new(sub_question, :scale_id=>0, :status_questions=>status_questions,
                                            ...
                                            :lime_answers=>lime_answers, :data_column_name=>"#{sub_question.rc_resp_name}#0",
          ...
          @data.push ResponseSetGeneric.new(sub_question, :scale_id=>1, :status_questions=>status_questions,
                                            ...
                                            :lime_answers=>lime_answers, :data_column_name=>"#{sub_question.rc_resp_name}#1",
      ...
      def get_error_cols sub_question, scale_id
        [status_questions.find{|sq| sq.title == dual_scale_title(sub_question, scale_id) }.rc_resp_name]
      end
